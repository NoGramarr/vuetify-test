  ...
  <v-container>
    <v-layout
      ...
      <v-flex xs12 lg9 xl8>
        ...
        <v-card class="my-3 elevation-3">
          <v-card-title class="white--text primary">
            <v-icon left color="white">fas fa-user-friends</v-icon> passengers
          </v-card-title>
          <v-divider/>
        ...
        <v-card class="my-3 elevation-3">
          <v-card-title class="white--text primary">
            <v-icon left color="white">fas fa-map</v-icon> itinerary
          </v-card-title>
          <v-divider/>
              ...
              <template v-slot:default>
                ...
                <tbody>
                  <tr>
                    ...
                    <td/><td/><td/><td/><td/>
                    <td class="text-left"><v-btn text class="text-lowercase"><v-icon small left>fas fa-plus</v-icon>add</v-btn></td>
                  </tr>
                  <tr class="table-back">
                    <td class="text-left">
                    ...
                    <td class="text-left">
                      <v-menu nudge-width offset-y :close-on-content-click="false">
                        <template v-slot:activator="{ on }">
                          <v-text-field :value="departureDateAndTime" v-on="on" class="ma-2" hide-details readonly></v-text-field>
                        </template>
                        <v-card>
                          <v-card-text>
                            <v-layout row justify-center>
                    ...
                    <td class="text-left">
                      <v-menu nudge-width offset-y :close-on-content-click="false">
                        <template v-slot:activator="{ on }">
                          <v-text-field :value="arrivalDateAndTime" v-on="on" class="ma-2" hide-details readonly></v-text-field>
                        </template>
                        <v-card>
                          <v-card-text>
                            <v-layout row justify-center>
                    ...
                    <td class="text-left">
                      <v-select class="ma-2" hide-details :items="testValues"></v-select>
                    </td>
                  </tr>
                  <tr>
                      ...
                      <v-menu nudge-width offset-y :close-on-content-click="false">
                        ...
                        <v-card>
                          <v-card-text>
                            ...
                            <v-layout row justify-center>
                              <v-time-picker :landscape="$vuetify.breakpoint.name != 'xs'" v-model="departureDate"></v-time-picker>
                            </v-layout>
                          </v-card-text>
                        </v-card>
                      </v-menu>
        ...
        <v-layout justify-center row>
          <v-btn class="white--text elevation-12 accent" width="120"><v-icon left>fas fa-times</v-icon> Cancel</v-btn>
          <v-btn class="primary white--text elevation-13" width="120"><v-icon left>far fa-save</v-icon> Save</v-btn>
        </v-layout>
      </v-flex>
    </v-layout>
  </v-container>
